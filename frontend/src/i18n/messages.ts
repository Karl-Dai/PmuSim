...
export const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'update.ready': '更新已在后台下载完成，可以安装。',
    'update.failedTitle': '更新失败',
    'update.skip': '跳过此版本',
    'update.installNextLaunch': '下次启动自动更新',
  ...
  en: {
    ...
    'update.ready': 'The update was downloaded and verified in the background.',
    'update.failedTitle': 'Update Failed',
    'update.skip': 'Skip This Version',
    'update.installNextLaunch': 'Update on Next Launch',
